...
describe('The Resource accepted handler module', function() {
  ...
  beforeEach(function() {
    ...
    this.requireModule = function() {
      return require(`${this.moduleHelpers.modulePath}/backend/lib/resource/handlers/accepted`)(this.moduleHelpers.dependencies);
    };
  });
      ...
      this.requireModule().handle(payload)
        .then(() => {
          expect(emailModule.sender.send).to.have.been.calledWith({
            ...
            emailTemplateName: 'resource.accepted',
            context: { resource }
          });
          done();
        })
